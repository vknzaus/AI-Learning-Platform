        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            {onMenuToggle && (
              ...
              >
                <span
                  className={`text-duogreen-600 transition-transform duration-200 text-lg ${
            ...
            <div className="hidden sm:block ml-4">{getStatusIndicator()}</div>
          </div>

          {/* Navigation and Actions with Duolingo styling */}
          <div className="flex items-center space-x-4">
            {/* Mobile status indicator */}
            <div className="sm:hidden">{getStatusIndicator()}</div>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a
                href="#"
                className="text-duogray-700 hover:text-duogreen-600 font-semibold text-sm transition-all duration-200 px-3 py-2 rounded-lg hover:bg-duogreen-50"
              >
                📚 Courses
              </a>
              <a
                href="#"
                className="text-duogray-700 hover:text-duoblue-600 font-semibold text-sm transition-all duration-200 px-3 py-2 rounded-lg hover:bg-duoblue-50"
              >
                🎓 Programs
              </a>
              <a
                href="#"
                className="text-duogray-700 hover:text-duopurple-600 font-semibold text-sm transition-all duration-200 px-3 py-2 rounded-lg hover:bg-duopurple-50"
              >
                🏢 For Business
              </a>
