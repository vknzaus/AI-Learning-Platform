...
export const FunLabsLogo: React.FC<FunLabsLogoProps> = ({
  ...
  return (
    <div 
      className={`flex items-center ${config.spacing} ${className} ${onClick ? 'cursor-pointer' : ''}`}
      onClick={onClick}
    ...
    >
      ...
      <div className="absolute pointer-events-none">
        <div className="w-1 h-1 bg-duoyellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-bounce-subtle transition-opacity duration-300" style={{ animationDelay: '0.1s' }}></div>
        <div className="w-1 h-1 bg-duogreen-400 rounded-full opacity-0 group-hover:opacity-100 animate-bounce-subtle transition-opacity duration-300" style={{ animationDelay: '0.3s' }}></div>
        <div className="w-1 h-1 bg-duoblue-400 rounded-full opacity-0 group-hover:opacity-100 animate-bounce-subtle transition-opacity duration-300" style={{ animationDelay: '0.5s' }}></div>
      </div>
    </div>
  );
};
